...
1.  [Skonfigurowanie programu Skycure do użycia z funkcją logowania jednokrotnego usługi Azure Active Directory /intune-classic/deploy-use/configure-skycure-to-use-azure-active-directory-single-sign-on)
