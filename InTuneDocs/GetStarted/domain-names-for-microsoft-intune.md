...
1. Przejdź do [portalu zarządzania usługi Office 365](https://portal.office.com/Admin/Default.aspx) i zaloguj się na swoim koncie administratora.
    > [!IMPORTANT]
    > Sprawdź ogłoszenie     [Portal konta usługi Intune został scalony z portalem zarządzania usługi Office 365](https://docs.microsoft.com/en-us/intune/deploy-use/account-portal-merged-with-Office-365), aby uzyskać więcej informacji o tym, gdzie zarządzać użytkownikami, grupami i domenami usługi Microsoft Intune.
