...
##### [Konfigurowanie usługi Mobile Threat Defense](deploy-use/device-threat-protection-subscription-setup.md)
##### [Włączanie usługi Mobile Threat Defense](deploy-use/device-threat-protection-enable.md)
##### [Wdrażanie aplikacji usługi Mobile Threat Defense](deploy-use/device-threat-protection-apps.md)
##### [Włączanie zasad zgodności usługi Mobile Threat Defense](deploy-use/device-threat-protection-policy.md)
