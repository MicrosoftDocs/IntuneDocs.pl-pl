...
Poniższa tabela zawiera listę błędów, które mogą występować podczas rejestrowania urządzeń z systemem iOS w usłudze Intune. Udostępnij ten link administratorowi IT. Jeśli nie możesz znaleźć informacji kontaktowych administratora IT, sprawdź, czy są one dostępne w [witrynie sieci Web Portal firmy](http://portal.manage.microsoft.com).
