...
title: Ustawienia zasad systemu Mac OS X w usłudze Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
|Nazwa ustawienia|Szczegóły|
    ...
    |**Plik profilu konfiguracji**|Kliknij przycisk **Importuj**, następnie przejdź do profilu konfiguracji utworzonego przy użyciu programu Apple Configurator. **Porada:** zobacz sekcję [Jak utworzyć plik profilu konfiguracji](#BKMK_Prof) w tym temacie, aby uzyskać pomoc przy tworzeniu profilu konfiguracji.|
