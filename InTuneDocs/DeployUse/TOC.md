...
##### [Rejestracja asystenta ustawień systemu iOS](ios-setup-assistant-enrollment-in-microsoft-intune.md)
##### [Rejestracja bezpośrednia systemu iOS](ios-direct-enrollment-in-microsoft-intune.md)
##### [Rejestracja programu DEP dla systemu iOS](ios-device-enrollment-program-in-microsoft-intune.md)
...
### [Sterowanie ustawieniami usługi Microsoft Passport na urządzeniach](control-microsoft-passport-settings-on-devices-with-microsoft-intune.md)
...
### [Zasady zgodności urządzenia](introduction-to-device-compliance-policies-in-microsoft-intune.md)
#### [Tworzenie zasad zgodności urządzenia](create-a-device-compliance-policy-in-microsoft-intune.md)
#### [Dla systemu Android](android-compliance-policy-settings-in-microsoft-intune.md)
#### [Dla systemu iOS](ios-compliance-policy-settings-in-microsoft-intune.md)
...
#### [Zasady MAM dla systemu Android](android-mam-policy-settings.md)
#### [Zasady MAM dla systemu iOS](ios-mam-policy-settings.md)
