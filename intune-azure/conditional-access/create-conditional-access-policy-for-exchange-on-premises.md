...
- Należy użyć [łącznika lokalnego programu Exchange programu Exchange Active Sync](install-intune-on-premises-exchange-connector.md), który łączy usługę Intune z lokalnym programem Exchange.
