...
[Tworzenie zasad ochrony aplikacji w funkcji WIP](https://docs.microsoft.com/intune-azure/manage-apps/create-windows-information-protection-policy-with-intune)
