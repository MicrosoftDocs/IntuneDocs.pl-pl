...
# <a name="how-to-configure-device-restriction-settings-in-intune-azure-preview"></a>Konfigurowanie ustawień ograniczeń dotyczących urządzeń w wersji zapoznawczej usługi Intune Azure
