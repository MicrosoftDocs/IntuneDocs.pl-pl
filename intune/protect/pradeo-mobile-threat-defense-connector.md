...
description: Dowiedz się, jak integrować usługę Intune z łącznikiem Pradeo Mobile Threat Defense w celu kontrolowania dostępu urządzeń przenośnych do zasobów firmy.
keywords: ''
author: brenduns
ms.author: brenduns
manager: dougeby
...
![Koncepcyjny obraz przedstawiający wykrycie złośliwych aplikacji](./media/pradeo-mobile-threat-defense-connector/pradeo_maliciousapps_blocked.png)

**Dostęp udzielany po skorygowaniu:**

![Udzielono dostępu po wykryciu złośliwych aplikacji](./media/pradeo-mobile-threat-defense-connector/pradeo_maliciousapps_unblocked.png)
...
![Blokowanie dostępu do sieci za pośrednictwem sieci Wi-Fi](./media/pradeo-mobile-threat-defense-connector/pradeo_network_wifi_blocked.png)

**Dostęp udzielany po skorygowaniu:**

![Koncepcyjny obraz przedstawiający dostęp udzielany po skorygowaniu](./media/pradeo-mobile-threat-defense-connector/pradeo_network_wifi_unblocked.png)
...
![Blokowanie usługi SharePoint Online po wykryciu zagrożeń sieciowych](./media/pradeo-mobile-threat-defense-connector/pradeo_network_spo_blocked.png)

**Dostęp udzielany po skorygowaniu:**

![Koncepcyjny obraz przedstawiający dostęp udzielany po skorygowaniu — przykład dla programu Sharepoint](./media/pradeo-mobile-threat-defense-connector/pradeo_network_spo_unblocked.png)
