---
title: Błędy aktualizacji oprogramowania i ich opisy w usłudze Microsoft Intune — Azure | Microsoft Docs
description: Zapoznaj się z listą kodów błędów agenta aktualizacji oprogramowania w usłudze Microsoft Intune, wraz z kodem i opisem błędu oraz nazwą symboliczną.
keywords: ''
author: Brenduns
ms.author: brenduns
manager: dougeby
...
Poniższa tabela zawiera listę kodów błędów programu **Update Agent** usługi Intune. Jeśli nie możesz znaleźć w niej określonego kodu błędu, zobacz [listę kodów błędów usługi Windows Update](https://support.microsoft.com/help/938205/windows-update-error-code-list).
