...
- Subskrypcja usługi Microsoft Intune — [zarejestruj się, aby uzyskać bezpłatne konto](../fundamentals/free-trial-sign-up.md)
...
3. Zaloguj się do usługi Intune przy użyciu konta służbowego, a następnie wybierz pozycję **Dalej**. Jeśli wykonano kroki z przewodnika Szybki start dotyczącego [tworzenia użytkownika i przypisywania licencji](../fundamentals/quickstart-create-user.md), możesz zalogować się przy użyciu utworzonego konta użytkownika.
