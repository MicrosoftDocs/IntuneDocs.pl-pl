...
2. Na stronie **Instalator oprogramowania** Wydawcy oprogramowania wybierz opcję **Instalator oprogramowania** dla pozycji **Wybierz, w jaki sposób to oprogramowanie ma zostać udostępnione urządzeniom** i określ opcje:
   ...
   Jeśli na przykład chcesz opublikować aplikację o nazwie Application.msi w usłudze Intune, strona będzie wyglądała następująco: ![Strona konfiguracji oprogramowania wydawcy](./media/add-apps-for-windows-pcs-in-microsoft-intune/publisher-for-pc.png)
...
Po utworzeniu aplikacji następnym krokiem jest jej wdrożenie. Aby dowiedzieć się więcej, zobacz [Przypisywanie aplikacji do grup w usłudze Microsoft Intune](../apps/apps-deploy.md).
