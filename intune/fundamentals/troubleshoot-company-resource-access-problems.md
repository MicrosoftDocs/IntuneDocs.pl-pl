...
description: Zobacz listę błędów, kodów stanu, opisów i rozwiązań występujących podczas korzystania z urządzeń zarządzanych przez usługę MDM oraz podczas uzyskiwania dostępu do zasobów firmy, a także listę błędów występujących na urządzeniach z systemem iOS/iPadOS i błędów odpowiedzi OMA w usłudze Microsoft Intune.
keywords: ''
...
## <a name="errors-returned-by-iosipados-devices"></a>Błędy zwrócone przez urządzenia z systemem iOS/iPadOS
...
|-2016345687|0x87D101A9|Syncml(425): Żądane polecenie nie powiodło się, ponieważ nadawca nie ma wystarczających uprawnień kontroli dostępu (ACL) u odbiorcy.|
...
|-2016345689|0x87D101A7|Syncml(423): Żądane polecenie nie powiodło się, ponieważ usunięty nietrwale element został wcześniej całkowicie usunięty na serwerze.|
...
|-2016345705|0x87D10197|Syncml(407): Żądane polecenie nie powiodło się, ponieważ przy jego uruchomieniu musi zostać określone właściwe uwierzytelnianie.|
...
|-2016345711|0x87D10191|Syncml(401): Żądane polecenie nie powiodło się, ponieważ obiekt żądający musi określić właściwe uwierzytelnianie.|
...
|-2016345898|0x87D100D6|Syncml(214): Operacja anulowana. Polecenie SyncML zostało wykonane pomyślnie, ale żadne kolejne polecenia nie będą przetwarzane w ramach sesji.|
