...
- **Wybierz profil poczty e-mail, który ma być zarządzany przez usługę Intune**: Jeśli wybrano ustawienie **Konto e-mail musi być zarządzane przez usługę Intune**, kliknij opcję **Wybierz**, aby określić profil poczty e-mail usługi Intune. Ten profil poczty e-mail musi znajdować się na urządzeniu.
...
- **Wymagaj, aby poziom zagrożenia urządzenia był niższy lub równy podanemu poziomowi zagrożenia urządzenia** (system iOS 8.0 i nowsze): wybierz maksymalny poziom zagrożenia na potrzeby oznaczania urządzenia jako niezgodnego. Urządzenia, które przekraczają ten poziom zagrożenia, zostaną oznaczone jako niezgodne:
  - **Zabezpieczone**: ta opcja jest najbezpieczniejsza, ponieważ urządzenie nie może mieć żadnych zagrożeń. Jeśli urządzenie zostanie wykryte jako posiadające jakikolwiek poziom zagrożenia, zostanie ono ocenione jako niezgodne.
...
- **Wymagaj hasła do odblokowania urządzeń przenośnych**: pozycja **Wymagaj** wymusza na użytkownikach wprowadzanie hasła podczas uzyskiwania dostępu do swoich urządzeń. Urządzenia z systemem iOS używające haseł są szyfrowane.
...
- **Wymagany typ hasła**: określ, czy hasło ma zawierać tylko znaki **numeryczne**, czy też ma być dopuszczalna kombinacja cyfr i innych znaków (**Alfanumeryczne**).
- **Liczba znaków innych niż alfanumeryczne w haśle**: wprowadź minimalną liczbę znaków specjalnych (&, #, %, ! itd.), którą musi zawierać hasło.
