...
[!INCLUDE[shared-proc-lob-updateapp](./includes/shared-proc-lob-updateapp.md)]Uwaga: Aby usługa Intune mogła pomyślnie wdrożyć nowy plik IPA na urządzeniu, należy zwiększyć numer w ciągu znaków CFBundleVersion w pliku Info.plist w pakiecie IPA.
