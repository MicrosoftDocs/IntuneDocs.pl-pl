...
description: Przejrzyj ustawienia domyślne i dostępne dla różnych wersji linii bazowej zalecanych systemu Windows MDM, którymi można zarządzać za pomocą Microsoft Intune.
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 09/06/2019
...
- **zabezpieczenia**opartena 
  **wirtualizacji:** Włączfunkcjęvbszbezpiecznymrozruchem
::: zone-end
::: zone pivot="mdm-preview,mdm-may-2019"
