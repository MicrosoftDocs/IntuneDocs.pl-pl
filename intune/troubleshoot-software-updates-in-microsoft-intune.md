...
Poniższa tabela zawiera listę kodów błędów programu **Update Agent** usługi Intune. Jeśli nie możesz znaleźć określonego kodu błędu w tej tabeli, zobacz [listę kodów błędów usługi Windows Update](https://support.microsoft.com/help/938205/windows-update-error-code-list).
...
**Rozwiązanie**:  
1. Zaloguj się do witryny [Azure Portal](https://portal.azure.com) i otwórz obszar **Microsoft Intune**. 
2. Wybierz pozycję **Aktualizacje oprogramowania**.
3. Odrzuć wszystkie zastąpione aktualizacje, które mogą być zastosowane do systemu Windows 7 lub aplikacji (na przykład pakietu Microsoft Office) zainstalowanych na komputerach, których dotyczy problem.
