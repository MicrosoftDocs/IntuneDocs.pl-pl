...
description: Rozwiązanie Microsoft 365 Enterprise obejmuje usługę Microsoft Intune. Zobacz, jak usługa Intune umożliwia zarządzanie urządzeniami przenośnymi i zarządzania aplikacjami mobilnymi w Twojej organizacji. Przeczytaj typowych scenariuszy, a przy użyciu usługi Intune do wdrożenia usługi Microsoft 365 w danym środowisku.
...
Kluczowym zadaniem każdego administratora jest chronienie i zabezpieczanie danych i zasobów organizacji. To zadanie to *zarządzanie urządzeniami*. Użytkownicy mają wiele urządzeń, za pomocą których otwierają i udostępniają pliki osobiste, odwiedzają witryny internetowe oraz instalują aplikacje i gry. Tych tych samych użytkowników są również pracownikom i uczniom. Firma chce używać urządzeń dostęp do pracy i służbowego zasoby, takie jak wiadomości e-mail i programu OneNote. Zarządzanie urządzeniami umożliwia organizacjom chronienie i zabezpieczanie zasobów i danych. 
...
Odpowiedź brzmi [Microsoft Intune](https://docs.microsoft.com/intune/introduction-intune). Usługa Intune umożliwia zarządzanie urządzeniami przenośnymi (MDM, mobile device management) oraz zarządzanie aplikacjami mobilnymi (MAM, mobile app management). Oto niektóre kluczowe zadania wszelkich rozwiązań MDM i MAM:

- Obsługa zróżnicowanego środowiska mobilnego  bezpieczne zarządzanie urządzeniami z systemami iOS, Android, Windows i macOS
...
- Rozwiązanie **Microsoft 365** to kluczowy składnik upraszczania typowych zadań informatycznych. W Centrum administracyjnym usługi Microsoft 365 możesz tworzyć użytkowników i zarządzanie grupami. Możesz także uzyskać dostęp do innych usług, takich jak Intune, Azure AD i nie tylko. 
...
- Program **Windows Defender** zawiera wiele funkcji zabezpieczeń ułatwiających chronienie urządzeń z systemem Windows 10. Używanie usługi Intune i programu Windows Defender w połączeniu umożliwia na przykład: 
    ...
    - Użyj [Windows Defender Advanced Threat Protection (ATP)](https://docs.microsoft.com/intune/advanced-threat-protection) w celu zapobiegania naruszeniom zabezpieczeń na urządzeniach przenośnych. I pomaga ograniczyć wpływ naruszenia zabezpieczeń przez blokowanie użytkownika z zasobów firmy.
...
Po skonfigurowaniu usługi Intune wybiera się też opcję zarządzania urządzeniami wyłącznie w witrynie Azure Portal lub zarządzania urządzeniami za pomocą połączenia usługi Intune i rozwiązania Microsoft 365. [Migrowanie zarządzania urządzeniami przenośnymi do usługi Intune w witrynie Azure portal](https://www.microsoft.com/itshowcase/Article/Content/1042/Migrating-mobile-device-management-to-Intune-in-the-Azure-portal) jest analiza przypadku IT firmy Microsoft. W tym przypadku badań, zobacz, jak wybrać podejścia do zarządzania nowoczesnymi urządzeniami IT firmy Microsoft i przeczytaj wyciągnięte wnioski.
