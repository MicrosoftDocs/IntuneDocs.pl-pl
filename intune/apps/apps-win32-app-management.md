...
### <a name="process-flow-to-create-intunewin-file"></a>Przepływ procesu tworzenia pliku intunewin
   ...
   ![Przepływ procesu tworzenia pliku intunewin](./media/apps-win32-app-management/prepare-win32-app.svg)
...
### <a name="process-flow-to-add-a-win32-app-to-intune"></a>Przepływ procesu dodawania aplikacji Win32 do usługi Intune
   ...
   ![Przepływ procesu dodawania aplikacji Win32 do usługi Intune](./media/apps-win32-app-management/add-win32-app.svg)
