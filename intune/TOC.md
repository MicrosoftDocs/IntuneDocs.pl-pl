...
### [Aplikacje z obsługą zarządzania aplikacjami mobilnymi w systemie Android](end-user-mam-apps-android.md)
### [Aplikacje z obsługą zarządzania aplikacjami mobilnymi w systemie iOS](end-user-mam-apps-ios.md)
