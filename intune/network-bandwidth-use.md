...
[Optymalizację dostarczania można skonfigurować](delivery-optimization-settings.md) w ramach profilów konfiguracji urządzenia.
...
> [!NOTE]
> Usługi Microsoft Intune można użyć do zarządzania komputerami z systemem Windows albo [jako urządzeniami mobilnymi z wykorzystaniem zarządzania urządzeniami mobilnymi (MDM)](windows-enroll.md), albo jako komputerami z wykorzystaniem oprogramowania klienckiego usługi Intune. Firma Microsoft zaleca, aby klienci [używali rozwiązania MDM do zarządzania](windows-enroll.md) zawsze, gdy jest to możliwe. Podczas zarządzania w ten sposób usługa BranchCache nie jest obsługiwana. Aby uzyskać więcej informacji, zobacz temat [Porównanie zarządzania komputerami z systemem Windows jako komputerami i jako urządzeniami mobilnymi](pc-management-comparison.md).
