...
>[!TIP]
> Aby uzyskać więcej informacji na temat procesu implementacji usługi Intune, zobacz [Dodatkowe zasoby](planning-guide-resources.md).
...
>[!TIP]
> Więcej informacji o wymaganiach autonomicznej usługi Intune można znaleźć [tutaj](/intune/supported-devices-browsers).
...
-   Dowiedz się więcej na temat [konfiguracji zarządzania systemem iOS i komputerami Mac](/intune-classic/deploy-use/set-up-ios-and-mac-management-with-microsoft-intune).
...
-   Dowiedz się więcej na temat [dodawania i wdrażania zasad konfiguracji](/intune-classic/deploy-use/manage-settings-and-features-on-your-devices-with-microsoft-intune-policies).
...
-   Dowiedz się więcej na temat [rejestrowania urządzeń](/intune-classic/deploy-use/enroll-devices-in-microsoft-intune).
...
Następna sekcja zawiera wskazówki dotyczące [testowania i sprawdzania poprawności wdrożenia usługi Intune](planning-guide-test-validation.md).
