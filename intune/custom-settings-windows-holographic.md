...
> |OMA-URI|Typ danych|
> |---|---|
> |./Vendor/MSFT/Policy/Config/Authentication/AllowFastReconnect|Liczba całkowita<br/>0 — niedozwolone<br/>1 — dozwolone (ustawienie domyślne)|
...
> |OMA-URI|Typ danych|
> |---|---|
> |./Vendor/MSFT/Policy/Config/Update/AllowUpdateService|Liczba całkowita<br/>0 — usługa aktualizacji nie jest dozwolona <br/>1 — usługa aktualizacji jest dozwolona (ustawienie domyślne)|
...
> |OMA-URI|Typ danych|
> |---|---|
> |./Vendor/MSFT/Policy/Config/Settings/AllowVPN|Liczba całkowita<br/>0 — niedozwolone<br/>1 — dozwolone (ustawienie domyślne)|
...
> |OMA-URI|Typ danych|
> |---|---|
> |./Vendor/MSFT/Policy/Config/Update/RequireUpdateApproval|Liczba całkowita<br/>0 — nieskonfigurowane. Urządzenie instaluje wszystkie odpowiednie aktualizacje.<br/>1 — urządzenie instaluje tylko aktualizacje, które zarówno można zastosować, jak i znajdują się na liście zatwierdzonych aktualizacji. Ustaw te zasady na wartość 1, jeśli dział IT chce kontrolować wdrożenia aktualizacji na urządzeniach, np. wtedy, gdy przed wdrożeniem jest wymagane testowanie.|
...
> |OMA-URI|Typ danych|
> |---|---|
> |./Vendor/MSFT/Policy/Config/Update/UpdateServiceUrl|Ciąg<br/>Adres URL — urządzenie sprawdza dostępność aktualizacji na serwerze WSUS pod określonym adresem URL.<br/>Nieskonfigurowane — urządzenie sprawdza dostępność aktualizacji w witrynie Microsoft Update.|
...
> |OMA-URI|Typ danych|
> |----|---|
> |./Vendor/MSFT/AccountManagement/UserProfileManagement/DeletionPolicy|Liczba całkowita<br/>0 — usuwanie natychmiast po powrocie urządzenia do stanu bez aktywnych użytkowników<br/>1 — usuwanie po osiągnięciu progu pojemności magazynu (ustawienie domyślne)<br/>2 — usuwanie zarówno po osiągnięciu progu pojemności magazynu, jak i po osiągnięciu progu nieaktywności profilu|
...
> |OMA-URI|Typ danych|
> |----|---|
> |./Vendor/MSFT/AccountManagement/UserProfileManagement/EnableProfileManager|Wartość logiczna<br/>True — włączone<br/>False — wyłączone (ustawienie domyślne)|
...
> |OMA-URI|Typ danych|
> |----|---|
> |./Vendor/MSFT/AccountManagement/UserProfileManagement/ProfileInactivityThreshold|Liczba całkowita<br/>Wartość domyślna to 30.|
...
> |OMA-URI|Typ danych|
> |----|---|
> |./Vendor/MSFT/AccountManagement/UserProfileManagement/StorageCapacityStartDeletion|Liczba całkowita<br/>Wartość domyślna to 25.|
...
> |OMA-URI|Typ danych|
> |----|---|
> |./Vendor/MSFT/AccountManagement/UserProfileManagement/StorageCapacityStopDeletion|Liczba całkowita<br/>Wartość domyślna to 50.|
