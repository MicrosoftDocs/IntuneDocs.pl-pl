...
![Wykryto złośliwe aplikacje](./media/pradeo_maliciousapps_blocked.png)
...
![Dostęp udzielany po skorygowaniu](./media/pradeo_network_wifi_unblocked.png)
...
![Dostęp udzielany po skorygowaniu — przykład dla programu Sharepoint](./media/pradeo_network_spo_unblocked.png)
