...
ms.locfileid: "61509555"
---
# <a name="required-metadata"></a>wymagane metadane

title: [TYTUŁ ARTYKUŁU | NAZWA USŁUGI] description: keywords: author: [NAZWA UŻYTKOWNIKA USŁUGI GITHUB] manager: [ALIAS] ms.date: 04/28/2016 ms.topic: article ms.prod: ms.service: ms.technology: ms.assetid: [NALEŻY POBRAĆ Z guidgenerator.com]
